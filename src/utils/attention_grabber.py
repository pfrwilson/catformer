...
class AttentionGrabber():
    ...
    def get_attention_at_query_point(self, layer: Optional[int]=None, head: Optional[int]=None, token: Optional[int]=None):
    ...
    def get_attention_maps(self, layer: Optional[int]=None, 
        ...
        sequence_attention = self.get_attention_at_query_point(layer, head, token)
